...
**Blocked on:** 3 blocks Stage 3; 4 blocks Stage 4. Stage 0 needs only 8 and 10. Decisions
1, 2 and 5 are answered (see *Answered*, 15 September): Construction is mapped later
