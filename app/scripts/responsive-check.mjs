...
const ROUTES = ["/", "/dashboard", "/projects", "/jobs", "/reports", "/processes", "/setup/properties", "/setup/processes", "/contacts", "/setup/contacts", "/setup/notifications", "/maintenance", "/setup/maintenance",
