...
export function createStubRepository(): Repository {
  ...
  return {
    ...
    async listSubstages() { return []; },
    async createSubstage(): Promise<never> { throw new Error("Defining a sub-stage needs Supabase."); },
    async updateSubstage(): Promise<never> { throw new Error("Editing a sub-stage needs Supabase."); },
    async reorderSubstages(): Promise<never> { throw new Error("Reordering sub-stages needs Supabase."); },
    ...
    async listProcessSteps() { return []; },
    async listRunStepStates() { return []; },
    async exemptRunStep() {},
    async clearRunStepExemption() {},
    async listProcessStepDependencies() { return []; },
    async createProcessStep(): Promise<never> { throw new Error("Adding a step needs Supabase."); },
    async updateProcessStep(): Promise<never> { throw new Error("Editing a step needs Supabase."); },
    async deleteProcessStep(): Promise<never> { throw new Error("Removing a step needs Supabase."); },
