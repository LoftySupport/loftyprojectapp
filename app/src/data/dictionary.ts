...
export const DICTIONARY: DictionaryEntry[] = [
  ...
  e("process_steps.process_step_is_required", "Required", "A run cannot be marked complete while a required step is open (Stage 2 gate), and it does not complete itself while any step is open. Optional until somebody ticks it in Setup → Processes — Amber, 15 September: tasks are optional unless ticked required. Property steps carry the flag the old template list held, which is real data and was not overwritten.", "boolean", "Not null, default false.", "—", "created"),
