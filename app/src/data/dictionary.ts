...
export const DICTIONARY: DictionaryEntry[] = [
  ...
  e("addresses.address_street_number", "Street number", "The number on the street. Text for the same reason as the lot number.",
    "text", "Nullable. Was half of \"a street needs one of the two numbers\"; that check went in 0069 and the rule now applies only to jobs, through guard_job_address_is_a_street.",
    "Feeds consolidated_address.", "created"),
  e("addresses.address_street_1", "Street", "Street name and type — \"Ironbark Road\".", "text",
    "Nullable since 0037, which is what makes a locality address possible. Whether it is set is what address_precision reads; since 0069 it may stand with no number beside it, because \"the Mt Gambier division, Penola Road\" is a real thing to know before any lot has a frontage.",
    "Feeds consolidated_address.", "created"),
