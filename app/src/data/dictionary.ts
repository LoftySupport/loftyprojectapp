...
export const DICTIONARY: DictionaryEntry[] = [
  ...
  e("projects.project_proposed_dwellings", "Proposed dwellings",
    ...
    "The form asks for the split and the repository writes this as the sum, so the two cannot disagree. The actual count is count(*) over jobs.project_id — derived, never stored. The CONFIRMED count is that same count excluding cancelled jobs.",
    "created"),
