      ...
      <div className="panel" style={{ marginBottom: "var(--space-16)" }}>
        <Text type="text2">
          {configured
            ...
            : "Supabase is not configured — set VITE_SUPABASE_URL and VITE_SUPABASE_PUBLISHABLE_KEY in .env.local, or set them in the Vercel project. A Supabase host integration may supply the same two values as VITE_SUPABASE_DATABASE_URL and VITE_SUPABASE_ANON_KEY. Both spellings are read, at build time. Until then every method returns empty and the app renders its structure only."}
        </Text>
      </div>
